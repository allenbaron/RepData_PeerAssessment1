...
``` {r interval_steps}
avg_interval <- group_by(activity, interval) %>%
                summarize(average_steps = mean(steps, na.rm = TRUE))
qplot(interval, average_steps, data = avg_interval, geom = "line")
max_steps <- max(avg_interval$average_steps)
max_interval <- avg_interval[avg_interval$average_steps %in% max_steps, "interval"]
```
